...
class SnakeGame:
    ...
    def __init__(self):
        ...
        rx=random.randrange(16,571,self.step)
        ry=random.randrange(16,346,self.step)
    ...
    "=== View Part ==="        
    def draw_wall(self):
        self.canvas.create_line((13,13),(13,363),fill='blue',width=5)
        self.canvas.create_line((13,363),(588,363),fill='blue',width=5)
        self.canvas.create_line((588,363),(588,13),fill='blue',width=5)
        self.canvas.create_line((588,13),(13,13),fill='blue',width=5)
    ...
    def random_food(self):      
        return(random.randrange(16,571,self.step),random.randrange(16,346,self.step))
